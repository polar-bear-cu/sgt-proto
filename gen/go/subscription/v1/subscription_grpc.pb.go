...
func (c *subscriptionServiceClient) GetSubscriptionsForReport(ctx context.Context, in *GetSubscriptionsForReportRequest, opts ...grpc.CallOption) (*GetSubscriptionsForReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSubscriptionsForReportResponse)
	err := c.cc.Invoke(ctx, SubscriptionService_GetSubscriptionsForReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SubscriptionService_GetSubscriptionsForReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSubscriptionsForReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubscriptionServiceServer).GetSubscriptionsForReport(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubscriptionService_GetSubscriptionsForReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).GetSubscriptionsForReport(ctx, req.(*GetSubscriptionsForReportRequest))
	}
